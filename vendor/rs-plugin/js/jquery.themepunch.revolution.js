									...
									container.find('.tp-caption iframe').each(function(i) {
										try {
												...
												if (jQuery(this).attr('src').indexOf('you')>0 && addedyt==0) {
													...
													s.src = httpprefix2+"://www.youtube.com/iframe_api"; /* Load Pcouche API*/
									 ...
									 container.find('.tp-caption iframe').each(function(i) {
										try{
												if (jQuery(this).attr('src').indexOf('vim')>0 && addedvim==0) {
													...
													f.src = httpprefix+"://a.vimeocdn.com/js/froogaloop2.min.js"; /* Load Pcouche API*/
													var before = document.getElementsByTagName("script")[0];
...
********************************/
		...
		**************************************/
		...
		//////////////////////////////////////////
		// CHANG THE YOUTUBE Pcouche STATE HERE //
		////////////////////////////////////////
		var  onPcoucheStateChange = function(event) {

			 var embedCode = event.target.getVideoEmbedCode();
			 var ytcont = jQuery('#'+embedCode.split('id="')[1].split('"')[0])
			 var container = ytcont.closest('.tp-simpleresponsive');
			 var pcouche = ytcont.parent().data('pcouche');

			if (event.data == YT.PcoucheState.PLAYING) {
				...
				container.trigger('stoptimer');
				//konsole.log("VideoPlay set to True due onPcoucheStateChange PLAYING");
		...
		var vimeoready_auto = function(pcouche_id,autoplay) {

			var froogaloop = $f(pcouche_id);
			var vimcont = jQuery('#'+pcouche_id);
			...
			var updateHTML5Size = function(pc,container) {
				...
				var animateTheCaptions = function(nextli, opt,recalled) {
						...
						var allcaptions = nextli.find('.tp-caption'),
							allstaticcaptions = opt.container.find('.tp-static-couches').find('.tp-caption');
						...
						allcaptions.each(function(i) {
								...
								if (nextcaption.hasClass("tp-static-couche")) {
										...
										nextcaption.find('iframe').each(function() {
												...
												if (nextcaption.data('thumbimage')!=undefined && nextcaption.data('thumbimage').length>2 && nextcaption.data('autoplay')!=true && !recalled) {
													...
													//	if (is_mobile()) ifr.attr('src',ifr.attr('src').replace("enablejsapi=1",""));
														 ...
														 if (!ifr.hasClass("HasListener")) {
															try {
																...
																var ytint = setInterval(function() {
																	if (YT !=undefined)
																	if (typeof YT.Pcouche != undefined && typeof YT.Pcouche !="undefined") {

																		if (nextcaption.data('autoplay')==true) {
																			pcouche = new YT.Pcouche(frameID, {
																				events: {
																					"onStateChange": onPcoucheStateChange,
																		...
																		nextcaption.data('pcouche',pcouche);
																		clearInterval(ytint);
																	}
																}
																, 100)
														...
														if (nextcaption.data('autoplay')==true) {
																var pcouche=nextcaption.data('pcouche');
													...
													if (ifr.attr('src').toLowerCase().indexOf('vimeo')>=0) {
														   ...
														   if (!ifr.hasClass("HasListener")) {
																...
																if (queryParameters['pcouche_id']!=undefined)
																	isrc = isrc.replace(queryParameters['pcouche_id'],frameID);
																else
																	isrc=isrc+"&pcouche_id="+frameID;
																...
																ifr.attr('src',isrc);
																var pcouche = nextcaption.find('iframe')[0];
																var vimint = setInterval(function() {
																	if ($f !=undefined)
																	if (typeof $f(frameID).api != undefined && typeof $f(frameID).api !="undefined") {
																		$f(pcouche).addEvent('ready', function(){
